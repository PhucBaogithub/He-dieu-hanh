    ...
    public partial class Form1 : Form
    {
            ...
            try
            {
                ...
                { //lặp trong khi chưa có yêu cầu kết thúc
                  //xác ₫ịnh tọa ₫ộ hiện hành của thread
                    ...
                    // Xóa vị trí cũg.FillRectangle(brush, xCell * x1, yCell * y1, xCell, yCell);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < 26; i++)
            {
                ...
                char c = (char)(i + 65);
                //₫ọc bitmap miêu tả thread c từ fileTrang 2
                //myStream = myAssembly.GetManifestResourceStream("Thread_Bitmap.Resources.Image" + c.ToString() + ".bmp");
                myStream = myAssembly.GetManifestResourceStream(myAssembly.GetName().Name + "."+ "Resources"+ "." + c.ToString() + ".bmp");
